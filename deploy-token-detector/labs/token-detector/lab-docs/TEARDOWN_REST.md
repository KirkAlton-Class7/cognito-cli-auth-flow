...
Use this to tear down the REST Cognito auth deployment plus the unused-token detector resources created by this lab. Skip any command for a resource you did not create.
