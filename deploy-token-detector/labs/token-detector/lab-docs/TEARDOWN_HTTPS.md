# Unused Token Detector HTTPS Teardown

Use this to tear down an HTTPS/HTTP API version of the unused-token detector. This removes the base HTTPS resources plus detector resources.
