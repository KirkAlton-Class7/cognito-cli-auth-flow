...
Remove the token detector REST deployment resources, then verify that add-on, identity, API, logging, alerting, and IAM lookups return deleted or empty results.
