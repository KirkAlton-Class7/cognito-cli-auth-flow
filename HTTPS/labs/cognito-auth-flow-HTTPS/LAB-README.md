...
| --- | --- | --- |
| `/prod/jedi` | Python | Validates the Python Lambda path after JWT authorization succeeds |
| `/prod/sith` | Node.js | Validates the Node.js Lambda path after JWT authorization succeeds |
