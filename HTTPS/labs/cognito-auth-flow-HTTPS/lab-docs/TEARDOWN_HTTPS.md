...
Remove the Cognito auth flow HTTPS lab resources, then verify that API, Lambda, Cognito, CloudWatch, and IAM lookups return deleted or empty results.
...
| File | Use |
| --- | --- |
| [`../env.example`](../env.example) | Lab environment template showing HTTPS values required by teardown. |
| [`../LAB-README.md`](../LAB-README.md) | HTTPS lab document map. |
| [`LAB-CLI.md`](LAB-CLI.md) | CLI lab that creates the resources removed here. |
| [`LAB-CONSOLE.md`](LAB-CONSOLE.md) | Console lab that creates the resources removed here. |
