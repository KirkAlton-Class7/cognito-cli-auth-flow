...
The HTTPS deployment uses API Gateway HTTP API with a built-in JWT authorizer. Cognito owns the user authentication flow. API Gateway validates the token before Lambda runs.
