...
Remove the Cognito auth flow REST lab resources, then verify that API, Lambda, Cognito, CloudWatch, and IAM lookups return deleted or empty results.
...
| File | Use |
| --- | --- |
| [`../env.example`](../env.example) | Lab environment template showing REST values required by teardown. |
| [`../LAB-README.md`](../LAB-README.md) | REST lab document map. |
